...
const CATS=[
  {{key:'juridico',label:'Jurídico',color:'#93C5FD',emoji:'⚖️',agents:[
    ...
    {{id:'ben-analista-processual',e:'🔬',s:'Analista Processual',n:'BEN Analista Processual'}},
...
const DESCS={{
  ...
  'ben-super-agente-juridico':'Análise jurídica de máxima profundidade com Claude Opus.',
  ...
  'ben-peticionista-juridico':'Elaboração de petições jurídicas especializadas.',
  'ben-contratualista':'Análise e elaboração de contratos.',
  'ben-mandatario-juridico':'Poderes, mandatos e representações legais.',
  'ben-analista-processual':'Análise detalhada de processos judiciais.',
  'ben-tributarista':'Questões tributárias e fiscais especializadas.',
  'ben-trabalhista':'Direito do trabalho e relações trabalhistas.',
  'ben-previdenciarista':'Previdência social e benefícios INSS.',
  'ben-constitucionalista':'Direito constitucional e direitos fundamentais.',
  'ben-especialista-compliance':'Compliance, governança e gestão de riscos.',
  'ben-pesquisador-juridico':'Pesquisa jurídica com fontes atualizadas.',
  'ben-relator-juridico':'Relatórios e pareceres jurídicos detalhados.',
  'ben-redator-juridico':'Redação jurídica precisa e fundamentada.',
  'ben-auditor-processual':'Auditoria de processos e validação jurídica.',
  'ben-gestor-juridico':'Gestão estratégica de departamentos jurídicos.',
  'ben-revisor-juridico':'Revisão e validação de documentos jurídicos.',
  'ben-peticionista':'Peticionamento geral em diversas áreas.',
