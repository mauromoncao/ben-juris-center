...
export const AGENT_CATEGORIES: AgentCategory[] = [
  {
    ...
    agents: [
      { id: 'ben-super-agente-juridico',        emoji: '⭐', shortName: 'Agente Maximus',         name: 'AGENTE OPERACIONAL MAXIMUS',           model: 'Claude Opus 4',    badge: 'OPUS',   badgeColor: '#92400e', category: 'juridico' },
      ...
      { id: 'ben-peticionista-juridico',        emoji: '⚖️', shortName: 'Peticionista',            name: 'BEN Peticionista Jurídico',            model: 'Claude Haiku 4.5', category: 'juridico' },
      { id: 'ben-contratualista',               emoji: '📋', shortName: 'Contratualista',          name: 'BEN Contratualista',                   model: 'Claude Haiku 4.5', category: 'juridico' },
      { id: 'ben-mandatario-juridico',          emoji: '📜', shortName: 'Mandatário',              name: 'BEN Mandatário Jurídico',              model: 'Claude Haiku 4.5', category: 'juridico' },
      { id: 'ben-analista-processual',          emoji: '🔬', shortName: 'Analista Proc.',          name: 'BEN Analista Processual',              model: 'GPT-4o',           category: 'juridico' },
      { id: 'ben-tributarista',                 emoji: '💰', shortName: 'Tributarista',            name: 'BEN Tributarista',                     model: 'Claude Haiku 4.5', category: 'juridico' },
      { id: 'ben-trabalhista',                  emoji: '👷', shortName: 'Trabalhista',             name: 'BEN Trabalhista',                      model: 'GPT-4o',           category: 'juridico' },
      { id: 'ben-previdenciarista',             emoji: '🏛️', shortName: 'Previdenciarista',        name: 'BEN Previdenciarista',                 model: 'Claude Haiku 4.5', category: 'juridico' },
      { id: 'ben-constitucionalista',           emoji: '⚡', shortName: 'Constitucionalista',      name: 'BEN Constitucionalista',               model: 'GPT-4o',           category: 'juridico' },
      { id: 'ben-especialista-compliance',      emoji: '🛡️', shortName: 'Compliance',              name: 'BEN Especialista Compliance',          model: 'GPT-4o',           category: 'juridico' },
      { id: 'ben-pesquisador-juridico',         emoji: '🔎', shortName: 'Pesquisador',             name: 'BEN Pesquisador Jurídico',             model: 'Perplexity',       category: 'juridico' },
      { id: 'ben-relator-juridico',             emoji: '📚', shortName: 'Relator',                 name: 'BEN Relator Jurídico',                 model: 'GPT-4o',           category: 'juridico' },
      { id: 'ben-redator-juridico',             emoji: '✒️', shortName: 'Redator',                 name: 'BEN Redator Jurídico',                 model: 'GPT-4o',           category: 'juridico' },
      { id: 'ben-auditor-processual',           emoji: '🔏', shortName: 'Auditor',                 name: 'BEN Auditor Processual',               model: 'Claude Haiku 4.5', category: 'juridico' },
      { id: 'ben-gestor-juridico',              emoji: '🏢', shortName: 'Gestor',                  name: 'BEN Gestor Jurídico',                  model: 'GPT-4o',           category: 'juridico' },
      { id: 'ben-revisor-juridico',             emoji: '📝', shortName: 'Revisor',                 name: 'BEN Revisor Jurídico',                 model: 'Claude Haiku 4.5', category: 'juridico' },
      { id: 'ben-peticionista',                 emoji: '⚖️', shortName: 'Peticionista G.',         name: 'BEN Peticionista',                     model: 'Claude Haiku 4.5', category: 'juridico' },
    ],
  },
  {
