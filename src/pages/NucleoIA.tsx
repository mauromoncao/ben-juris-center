...
const DR_BEN_AGENTS = [
  // ── AGENTE OPERACIONAL MAXIMUS (topo absoluto da hierarquia) ──────────────
  {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl p-6 relative overflow-hidden" style={{ background: '#FFFFFF', border: '1px solid #E5E7EB', boxShadow: '0 1px 6px rgba(25,56,92,0.08)' }}>
        ...
        <div className="relative flex items-start justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm max-w-2xl" style={{ color: '#6B7280' }}>Agentes especialistas de alta performance integrados ao ecossistema BEN IA. Análise tributária estratégica, processualista, perícia forense, contador tributarista e operacionais — automatizados com precisão jurídica.</p>
            </div>
          </div>
          <div className="flex gap-3">
        ...
        <div className="relative mt-4 flex items-center gap-6">
          {[
            ...
            { icon: Activity, label: '99.9% Uptime', color: '#0891b2' }].map((item) => (
      ...
      <div className="flex gap-1 bg-slate-100 p-1 rounded-xl border border-slate-200 w-fit">
        {[
          ...
          { id: 'insights', label: 'Insights IA', icon: Lightbulb }].map(tab => (
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Prazo Crítico', value: '2', icon: AlertTriangle, color: '#dc2626', sub: 'próximos 7 dias' }].map(card => (
            ...
            {[
              {
                title: 'Top Agentes Utilizados', items: [
                  { name: 'Agente Operacional Premium', usage: 1547, pct: 40 },
                  { name: 'Tributarista Estrategista', usage: 634, pct: 26 },
                  { name: 'Processualista Estratégico', usage: 412, pct: 17 },
                  { name: 'Contador Tributarista', usage: 298, pct: 12 },
                  { name: 'Perito Forense', usage: 256, pct: 10 }]
              },
              {
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { type: 'warning', icon: Clock, msg: '2 audiências amanhã sem checklist concluído. Recomendo acionar o Agente Operacional Premium para elaboração de memoriais.' },
                  ...
                  { type: 'info', icon: Brain, msg: 'Nova súmula STJ (nº 668) impacta 4 processos ativos. AGENTE OPERACIONAL MAXIMUS analisará e sugerirá estratégia multi-instância.' }].map((item, i) => {
            ...
            <div className="card">
              ...
              <div className="space-y-3">
                {[
                  {
                    agent: 'Processualista Estratégico',
                    color: '#059669',
                  ...
                  {
                    agent: 'Tributarista Estrategista',
                    color: '#dc2626',
                  ...
                  {
                    agent: 'Agente Operacional Premium',
                    color: '#0891b2',
                  ...
                  {
                    agent: 'Contador Tributarista',
                    color: '#0f766e',
                    rec: 'Score de conformidade tributária em 75%. 3 pendências críticas identificadas para alcançar 95%+.',
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Economia Financeira', value: 'R$ 94k', sub: 'em produtividade', icon: TrendingUp, color: '#7c3aed', change: '+18%' }].map(card => (
              <div key={card.label} className="card-compact">
                <div className="flex items-center justify-between mb-2">
          ...
          <div className="rounded-xl border border-slate-200 p-5" style={{ background: 'rgba(25,56,92,0.03)' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
              {[
                ...
                { name: 'Ben Growth Center', status: 'Integrado', icon: Link2, color: '#d97706' }].map(item => (
