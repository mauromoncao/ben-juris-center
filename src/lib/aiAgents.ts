...
'ben-assistente-geral': {
 ...
 emoji:'🤖',
 area:'geral',
 modelo:'ben-ia-search',
 modelo_fallback:'ben-ia-search',
 temperatura: 0.5,
 max_tokens: 4096,
 cor:'text-yellow-400',
 cor_bg:'bg-yellow-500/10',
 cor_border:'border-yellow-500/30',
 descricao:'Copiloto fixo do Dr. Mauro. Sem restrições de domínio — direito, tecnologia, negócios, ciências, criatividade e tudo mais. Proativo, memória persistente Pinecone, dados em tempo real atualizados.',
 especialidades: [
...
'ben-agente-operacional-maximus': {
 ...
 titulo:'Agente Jurídico Operacional — Máxima Complexidade',
 emoji:'⭐',
 area:'operacional',
 modelo:'ben-ia-pro',
 modelo_fallback:'ben-ia-plus',
 temperatura: 0.05,
 max_tokens: 16000,
 cor:'text-amber-400',
 cor_bg:'bg-amber-500/10',
 cor_border:'border-amber-500/30',
 descricao:'Agente jurídico de máxima complexidade. Thinking sempre ativo. Raciocínio em 7 camadas. Casos com valor > R$ 500k, teses inovadoras, múltiplas instâncias, risco jurídico muito alto.',
 especialidades: [
...
'Redireciona para agente de maior complexidade',
 ],
 system_prompt:'Agente operacional padrão com BEN IA. Execução rápida de tarefas operacionais. Thinking desativado.',
 exemplos_uso: [
...
'Análise de risco com cenários (melhor caso, provável, pior caso)',
 ...
 system_prompt:'Agente tributarista estrategista com BEN IA Pro. Especialista exclusivo em Direito Tributário Puro. Thinking sempre ativo. Raciocínio em 7 camadas tributárias.',
 exemplos_uso: [
...
'ben-pesquisador-juridico': {
 ...
 titulo:'BEN Pesquisador Jurídico — Busca em Tempo Real',
 emoji:'🔬',
 area:'pesquisa',
 modelo:'ben-ia-search',
 modelo_fallback:'ben-ia-plus',
...
'ben-contador-tributarista': {
 ...
 titulo:'Triagem e Consultas Fiscais',
 emoji:'📊',
 area:'tributario',
 modelo:'ben-ia-plus',
 modelo_fallback:'ben-ia-pro',
 temperatura: 0.1,
 max_tokens: 6000,
 cor:'text-emerald-400',
 cor_bg:'bg-emerald-500/10',
 cor_border:'border-emerald-500/30',
 descricao:'Consultas fiscais com BEN IA com pesquisa em tempo real (IN RFB + CARF + legislação atualizada) + Thinking adaptativo + memória Pinecone.',
...
'ben-contador-especialista': {
 ...
 cor_bg:'bg-emerald-500/10',
 cor_border:'border-emerald-500/30',
 descricao:'Análise tributária profunda. Nível 2 da arquitetura Contador com domínio total de Simples Nacional, Reforma Tributária e defesa fiscal.',
 especialidades: [
...
'ben-contador-planejamento': {
 ...
 cor_bg:'bg-emerald-500/10',
 cor_border:'border-emerald-500/30',
 descricao:'Planejamento tributário estratégico com BEN IA com pesquisa em tempo real (legislação atualizada + CARF) + Thinking adaptativo + memória Pinecone.',
...
'ben-contador-creditos': {
 ...
 cor_bg:'bg-emerald-500/10',
 cor_border:'border-emerald-500/30',
 descricao:'Recuperação de créditos tributários com BEN IA com pesquisa em tempo real (teses STF/CARF atualizadas) + Thinking adaptativo + memória Pinecone.',
...
'ben-contador-auditoria': {
 ...
 cor_bg:'bg-emerald-500/10',
 cor_border:'border-emerald-500/30',
 descricao:'Auditoria fiscal com BEN IA com pesquisa em tempo real (IN RFB + CARF atualizados) + Thinking adaptativo + memória Pinecone.',
...
'ben-contador-relatorio': {
 ...
 cor_bg:'bg-emerald-500/10',
 cor_border:'border-emerald-500/30',
 descricao:'Relatórios contábeis e laudos judiciais com BEN IA com pesquisa em tempo real + Thinking adaptativo + memória Pinecone.',
...
'ben-perito-forense': {
 ...
 descricao:'Análise pericial multidisciplinar de 5 módulos: Perícia Contábil, COAF/UIF, Documentos (7 camadas), Vínculos (Link Analysis) e Conformidade Técnica. Nível 1 de análise pericial.',
...
'ben-perito-forense-profundo': {
 ...
 cor_bg:'bg-red-500/10',
 cor_border:'border-red-500/30',
 descricao:'⚠️ Nível 2 — IA com raciocínio adaptativo máximo. Aciona ALERTA AUTOMÁTICO ao Dr. Mauro. Para RIF/COAF, laudos criminais, vínculos complexos, cadeia de custódia.',
 especialidades: [
...
'ben-perito-imobiliario': {
 ...
 descricao:'Perícias imobiliárias com metodologia ABNT NBR 14.653 + BEN IA Search nativo. Avaliação judicial de imóveis, apuração de danos, cálculo de benfeitorias, partilhas e usucapião.', 
 especialidades: [
...
'ben-processualista-estrategico': {
 ...
 descricao:'Estratégia processual de alto nível com thinking sempre ativo. Petições, contestações, recursos, embargos. Domínio completo do CPC/2015, jurisprudência STJ/STF e teses processuais avançadas.',
 especialidades: [
...
'ben-monitor-juridico': {
 ...
 titulo:'Monitor DJe + CNJ DataJud + IA',
 emoji:'📡',
 area:'operacional',
 modelo:'ben-ia-plus',
 modelo_fallback:'ben-ia',
 ...
 especialidades: ['DJe Escavador','DataJud CNJ','Alertas de Prazo','Movimentações Processuais','Publicações Oficiais','Análise BEN IA'],
 capacidades: [
...
'ben-ia-pro':    { label:'BEN IA Pro',    color:'text-amber-400' },
'ben-ia-plus':   { label:'BEN IA Plus',   color:'text-blue-400' },
'ben-ia':        { label:'BEN IA',        color:'text-green-400' },
'ben-ia-search': { label:'BEN IA Search', color:'text-indigo-400' },
};
