...
'gpt-4o': { label:'BEN IA', color:'text-blue-400' },
'gpt-4o-mini': { label:'BEN IA', color:'text-blue-300' },
'claude-opus-4': { label:'BEN IA Pro', color:'text-amber-400' },
'claude-sonnet-4': { label:'BEN IA Plus', color:'text-amber-400' },
'claude-haiku-4': { label:'BEN IA', color:'text-green-400' },
'claude-haiku': { label:'BEN IA', color:'text-green-300' },
'perplexity': { label:'BEN IA Search', color:'text-indigo-400' },
};
